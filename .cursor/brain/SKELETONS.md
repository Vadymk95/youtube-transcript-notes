...
- Artifact contract drift: the agent flow assumes `manifest.json -> summary-prompt.md -> summary.<replyLanguage>.md -> validator`. Renaming files or changing manifest fields without updating the rules breaks the chat workflow.
